...
class IoUOHEMSampler(metaclass=ABCMeta):
    """
    ...
    def hard_mininig(self, inds, num_expected, bboxes, labels, 
                    iou_targets, feats):
        with torch.no_grad():
            ...
            loss = self.bbox_head.loss(
                ...
                iou_weights=iou_pred.new_ones(iou_pred.size(0), 1),
    ...
    def _sample_pos(self,
        ...
        if pos_inds.numel() <= num_expected:
            ...
            iou_targets = assign_result.max_overlaps[pos_inds][:, None]
            return self.hard_mininig(pos_inds, num_expected, bboxes[pos_inds],
                                    labels, iou_targets, feats)
